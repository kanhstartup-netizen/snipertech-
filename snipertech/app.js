                        ...
                        React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } },
                            ...
                            React.createElement("div", null,
                                ...
                                React.createElement("h1", { style: { fontFamily: "'LaoOverride','Sora','Noto Sans Lao',sans-serif", fontSize: "clamp(26px,6.5vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", margin: 0, lineHeight: 1.05, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } },
                                    "Sniper",
                                    React.createElement("span", { style: { background: `linear-gradient(95deg,#00E5FF,#2682FF)`, WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent", textShadow: "none", filter: `drop-shadow(0 0 12px rgba(0,229,255,0.6))` } }, "Tech"),
                                    React.createElement("span", { style: { background: `linear-gradient(95deg,#FFFFFF,#A9E0FF)`, WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent", fontWeight: 900, filter: `drop-shadow(0 0 10px rgba(255,255,255,0.5))` } }, " AI"),
